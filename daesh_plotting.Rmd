...
pacman::p_load(tidyverse, magrittr, haven, ggthemes, sjPlot, sjmisc, binoculaR, ggplot2, grid, gridExtra, gtable, cowplot)
...
grid_arrange_shared_legend <- function(...,
           ...
           caption,
           n = nrow(arab4 %>% 
                      select(cntry, daesh_goal_num, daesh_goal_num) %>% 
                      na.omit)) {
...
grid_arrange_shared_legend <- function(...,
           ...
           title,
           caption,
           n = nrow(arab4 %>% select(cntry, daesh_islam_num) %>% na.omit)) {
