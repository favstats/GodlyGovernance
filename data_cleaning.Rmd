...
arab_reg$islamism <- as.numeric(range01(arab_reg$islamism) * 100)
...
model1 <- lme4::lmer(islamism ~ female + work + income + age + educ + globalism + personalpiety + patriarchalvalues + liberalislam + (1|cntry/year), data = arab_reg)
...
model2 <- lme4::lmer(islamism ~ female + work + income + age + educ + globalism + personalpiety + patriarchalvalues + liberalislam + liberalislam*personalpiety + (1|cntry/year), data = arab_reg)
